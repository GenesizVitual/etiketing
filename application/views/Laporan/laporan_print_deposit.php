...
<body>
	...
	<table width="100%">
		<tr>
			...
			<td align="center">
				...
				<h3 style="margin-top: 0px;margin-bottom: 10px;">Laporan Penerimaan Isi Ulang Kartu <br> Pelabuhan Bau Bau</h3>
			</td>
			<td></td>
		</tr>	
	</table>
	...
	<div style="width: 100%; text-align: left; padding-bottom: 10px">
		<label style="padding-right: 5%; ">Jumlah data deposit klien : <?php echo count($data);?></label>
	</div>
	...
	<table border="1" width="100%" id="table">
		...
		<tbody>
			...
			<?php }?>
			<tr>
				<td colspan="4" align="center"><strong>Total Deposit</strong></td>
				<td><strong>Rp. <?php echo number_format($total->jumlah_total,0,'.','.');?></strong></td>
			</tr>
			<?php }else{?>
				<tr>
					<td colspan="5" align="center"><strong>Data Deposit Kosong</strong></td>
				</tr>
			<?php }?>
		</tbody>
	</table>
